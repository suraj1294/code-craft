    ...
    >
      ...
      <div className="relative flex items-center gap-8">
        ...
        <div className="space-y-3">
          <div className="h-8 w-48 bg-gray-800/80 rounded-sm animate-pulse" />
          <div className="h-5 w-32 bg-gray-800/80 rounded-sm animate-pulse" />
        </div>
      </div>
            ...
            <div className="relative space-y-4">
              ...
              <div className="flex items-start justify-between">
                <div className="space-y-2">
                  <div className="h-4 w-24 bg-gray-800/80 rounded-sm animate-pulse" />
                  <div className="h-8 w-16 bg-gray-800/80 rounded-sm animate-pulse" />
                  <div className="h-4 w-32 bg-gray-800/80 rounded-sm animate-pulse" />
                </div>
              ...
              <div className="pt-4 border-t border-gray-800/50 flex items-center gap-2">
                <div className="h-4 w-4 bg-gray-800/80 rounded-sm animate-pulse" />
                <div className="h-4 w-20 bg-gray-800/80 rounded-sm animate-pulse" />
                <div className="h-4 w-16 bg-gray-800/80 rounded-sm animate-pulse" />
              </div>
            </div>
          </div>
        ))}
