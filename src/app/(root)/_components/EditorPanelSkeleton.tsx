...
export function EditorPanelSkeleton() {
  return (
    <div className="relative">
      ...
      <div className="relative bg-[#12121a]/90 backdrop-blur-sm rounded-xl border border-white/[0.05] p-6 h-[600px]">
        ...
        <div className="relative rounded-xl overflow-hidden ring-1 ring-white/[0.05]">
          ...
          <div className="h-[600px] bg-[#1e1e2e]/50 backdrop-blur-xs p-4">
            {/* Code line skeletons */}
            {[...Array(15)].map((_, i) => (
  ...
  return (
    <div className="relative bg-[#181825] rounded-xl p-4 ring-1 ring-gray-800/50">
      ...
      <div className="relative">
        ...
        <div className="relative bg-[#1e1e2e]/50 backdrop-blur-xs border border-[#313244] rounded-xl p-4 h-[600px]">
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              <div className={`w-12 h-12 mx-auto mb-4 bg-white/5 rounded-xl`} />
              <div className={`w-48 h-4 mx-auto bg-white/5 rounded-sm`} />
            </div>
          </div>
        </div>
      </div>
