...
import { defineMonacoThemes, LANGUAGE_CONFIG } from "../constant";
...
import ShareSnippetDialog from "../../snippets/components/share-snippet-dialog";
...
function EditorPanel() {
  ...
  return (
    <div className="relative">
      <div className="relative bg-[#12121a]/90 backdrop-blur-sm rounded-xl border border-white/[0.05] p-6">
        {/* Header */}
